...
export default function AddTaskForm() {
  ...
  return (
    ...
    <div className="flex items-center space-x-2">
      ...
      />
      <button className="bg-blue-500 hover:bg-blue-600 text-white py-1 px-3 rounded focus:outline-none focus:ring focus:border-blue-300" onClick={handleAddTask}>Ajouter une tâche</button>
    </div>
  );
}